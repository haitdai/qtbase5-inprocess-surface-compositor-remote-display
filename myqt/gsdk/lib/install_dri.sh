...
#
PVRVERSION="sgxddk_1.9.RC2@2139099"
...
install_pvr()
{
	...
	install_file drm.ko /lib/modules/$(uname -r)/extra/drm.ko "kernel module" 0644 0:0
	if [ "$host" = 1 ]; then
			grep -v -e "extra/drm.ko" ${DISCIMAGE}/lib/modules/$(uname -r)/modules.dep >/tmp/modules.$$.tmp
	echo "/lib/modules/$(uname -r)/extra/drm.ko:" >>/tmp/modules.$$.tmp
...
echo "/lib/modules/$(uname -r)/extra/pvrsrvkm.ko: /lib/modules/$(uname -r)/extra/drm.ko" >>/tmp/modules.$$.tmp
	cp /tmp/modules.$$.tmp ${DISCIMAGE}/lib/modules/$(uname -r)/modules.dep
	fi
	...
	#
	install_file libGLES_CM.so /usr/lib/libGLES_CM.so.1.9.2139099 "shared library" 0644 0:0
	install_link libGLES_CM.so.1.9.2139099 /usr/lib/libGLES_CM.so


	install_file libusc.so /usr/lib/libusc.so.1.9.2139099 "shared library" 0644 0:0
	install_link libusc.so.1.9.2139099 /usr/lib/libusc.so

	install_file libGLESv2.so /usr/lib/libGLESv2.so.1.9.2139099 "shared library" 0644 0:0
	install_link libGLESv2.so.1.9.2139099 /usr/lib/libGLESv2.so

	install_file libglslcompiler.so /usr/lib/libglslcompiler.so.1.9.2139099 "shared library" 0644 0:0
	install_link libglslcompiler.so.1.9.2139099 /usr/lib/libglslcompiler.so



	install_file libIMGegl.so /usr/lib/libIMGegl.so.1.9.2139099 "shared library" 0644 0:0
	install_link libIMGegl.so.1.9.2139099 /usr/lib/libIMGegl.so
	install_file libEGL.so /usr/lib/libEGL.so.1.9.2139099 "shared library" 0644 0:0
	install_link libEGL.so.1.9.2139099 /usr/lib/libEGL.so
	install_file libpvr2d.so /usr/lib/libpvr2d.so.1.9.2139099 "shared library" 0644 0:0
	install_link libpvr2d.so.1.9.2139099 /usr/lib/libpvr2d.so

	install_file libpvrPVR2D_BLITWSEGL.so /usr/lib/libpvrPVR2D_BLITWSEGL.so.1.9.2139099 "shared library" 0644 0:0
	install_link libpvrPVR2D_BLITWSEGL.so.1.9.2139099 /usr/lib/libpvrPVR2D_BLITWSEGL.so
	install_file libpvrPVR2D_FLIPWSEGL.so /usr/lib/libpvrPVR2D_FLIPWSEGL.so.1.9.2139099 "shared library" 0644 0:0
	install_link libpvrPVR2D_FLIPWSEGL.so.1.9.2139099 /usr/lib/libpvrPVR2D_FLIPWSEGL.so
	install_file libpvrPVR2D_FRONTWSEGL.so /usr/lib/libpvrPVR2D_FRONTWSEGL.so.1.9.2139099 "shared library" 0644 0:0
	install_link libpvrPVR2D_FRONTWSEGL.so.1.9.2139099 /usr/lib/libpvrPVR2D_FRONTWSEGL.so
	install_file libpvrPVR2D_LINUXFBWSEGL.so /usr/lib/libpvrPVR2D_LINUXFBWSEGL.so.1.9.2139099 "shared library" 0644 0:0
	install_link libpvrPVR2D_LINUXFBWSEGL.so.1.9.2139099 /usr/lib/libpvrPVR2D_LINUXFBWSEGL.so

	install_file libpvrPVR2D_DRIWSEGL.so /usr/lib/libpvrPVR2D_DRIWSEGL.so.1.9.2139099 "shared library" 0644 0:0
	install_link libpvrPVR2D_DRIWSEGL.so.1.9.2139099 /usr/lib/libpvrPVR2D_DRIWSEGL.so

	install_file libsrv_um.so /usr/lib/libsrv_um.so.1.9.2139099 "shared library" 0644 0:0
	install_link libsrv_um.so.1.9.2139099 /usr/lib/libsrv_um.so
	install_file libsrv_init.so /usr/lib/libsrv_init.so.1.9.2139099 "shared library" 0644 0:0
	install_link libsrv_init.so.1.9.2139099 /usr/lib/libsrv_init.so
	install_file libPVRScopeServices.so /usr/lib/libPVRScopeServices.so.1.9.2139099 "shared library" 0644 0:0
	install_link libPVRScopeServices.so.1.9.2139099 /usr/lib/libPVRScopeServices.so
...
echo
echo "Installing PowerVR Consumer/Embedded DDK 'sgxddk_1.9.RC2@2139099' on $from"
echo
