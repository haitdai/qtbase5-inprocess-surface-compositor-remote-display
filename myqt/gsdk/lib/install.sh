...
echo "/lib/modules/$(uname -r)/extra/omaplfb.ko: /lib/modules/$(uname -r)/extra/pvrsrvkm.ko" >>/tmp/modules.$$.tmp
	...
	install_file libpvrEWS_WSEGL.so /usr/lib/libpvrEWS_WSEGL.so.1.9.2139099 "shared library" 0644 0:0
	install_link libpvrEWS_WSEGL.so.1.9.2139099 /usr/lib/libpvrEWS_WSEGL.so
