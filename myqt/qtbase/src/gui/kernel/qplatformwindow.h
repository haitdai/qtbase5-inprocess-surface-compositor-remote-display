...
#ifdef QT_MROFS
class QPlatformCompositor;
class QPlatformImage;
#endif

/*!
    QWindow inherits from QSurface
    QPlatformSurface include QSurface
*/
...
#ifdef QT_MROFS
    virtual void setCompositor(QPlatformCompositor *plat_compositor) { Q_UNUSED(plat_compositor);};
    virtual QPlatformImage *createShadowImage(const QRect rect) { Q_UNUSED(rect); return NULL; };
    virtual void destroyShadowImage() {};
    virtual QPlatformImage *shadowImage() { return NULL; };
#endif
