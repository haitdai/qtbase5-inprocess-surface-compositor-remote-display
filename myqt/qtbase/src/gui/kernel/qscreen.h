...
#ifdef QT_MROFS_LEGACY	
    QPlatformCompositor *compositor() const;    //deprecated under QMrOfsV2
#endif    
    QString name() const;
...
#ifdef QT_MROFS_LEGACY	
    explicit QScreen(QPlatformScreen *screen, QPlatformCompositor *compositor);          //deprecated under QMrOfsV2
#endif    
