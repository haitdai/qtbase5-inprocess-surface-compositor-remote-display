...
//DHT20130928, nullBrushInstance_holder.operator=() return QNullBrushData*
Q_GLOBAL_STATIC(QNullBrushData, nullBrushInstance_holder)
static QBrushData *nullBrushInstance()
{
    //DHT20140928, return global singleton brush in QNullBrushData*, see global_static.h
...
QBrush &QBrush::operator=(const QBrush &b)
{
    ...
    b.d->ref.ref();
    d.reset(b.d.data());              //DHT20140925 OK see QBrushDataPointerDeleter
    return *this;
}
