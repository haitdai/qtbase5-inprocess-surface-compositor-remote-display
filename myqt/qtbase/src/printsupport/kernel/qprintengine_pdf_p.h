...
#ifdef QT_PRINTFILE
class QMDrawCmdPrintEnginePrivate;

class Q_PRINTSUPPORT_EXPORT QMDrawCmdPrintEngine : public QMDrawCmdFileEngine, public QPrintEngine
{
    Q_DECLARE_PRIVATE(QMDrawCmdPrintEngine)
public:
    QMDrawCmdPrintEngine(){}
    virtual ~QMDrawCmdPrintEngine(){}
    ...
    // end reimplementations QPrintEngine
protected:
    QMDrawCmdPrintEngine(QMDrawCmdPrintEngine &p);

private:
    Q_DISABLE_COPY(QMDrawCmdPrintEngine)
};

class Q_PRINTSUPPORT_EXPORT QMDrawCmdPrintEnginePrivate
{
public:
    QMDrawCmdPrintEnginePrivate() {}
    ~QMDrawCmdPrintEnginePrivate(){}
};
#endif //QT_PRINTFILE
