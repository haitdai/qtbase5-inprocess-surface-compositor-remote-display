...
{
    //DHT20141124, recursive updating from viewport [scrollarea sub tree root], triggered by scrollbar
    //could we do more efficiently here?  [static contents,  update disabled]
    //no use, see QScrollArea::scrollContentsBy
    viewport()->update();    
}
