...
public:
    ...
    QPlatformImage *platformImage();             //render picture for compositor, compositor thread, REPLACED BY getDC
...
private:
    ...
    QRegion                   m_dirty;              // bs dirty region, used by compositor, in TLW coordinate(note: not the src image dc coordinate, ref. offset argument in flush)
    // TODO: offset of TLW
#endif
};
