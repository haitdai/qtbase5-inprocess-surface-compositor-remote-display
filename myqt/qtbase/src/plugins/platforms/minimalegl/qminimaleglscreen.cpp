...
//DHT
Qt::ScreenOrientation QMinimalEglScreen::setOrientation(Qt::ScreenOrientation orientation)
{
    Qt::ScreenOrientation  old_orientation = m_orientation;
    m_orientation = orientation;
    //notify  by  emit QScreen.orientationChanged
