...
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.qt-project.Qt.QPA.QPlatformIntegrationFactoryInterface.5.2" FILE "mrofs_pvr2d.json")
public:
...
{
    Q_UNUSED(paramList);
    if (!system.compare(QLatin1String("mrofs_pvr2d"), Qt::CaseInsensitive))
