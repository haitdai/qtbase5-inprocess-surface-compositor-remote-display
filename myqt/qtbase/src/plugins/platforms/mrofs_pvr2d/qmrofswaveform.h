...
public:
    ...
    QRect geometry();
    QSize size();
    QPlatformImage *platformImage();                                 //picture for compositor    
    ...
    const QRegion& effectiveDirtyRegion();                //ref. effective_clip, xcb version
    QPoint originInTLW();
...
public:
    QMrOfsWaveController(QPlatformWindow *window);
