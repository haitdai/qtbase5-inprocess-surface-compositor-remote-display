...
class QMrOfsCompositor;                // shadow pixmap
class QXcbScreen;
...
public:
    ...
    xcb_render_picture_t shadowPicture();              // bs, wv, iv, cursor leayers' target, picture's source
    xcb_render_picture_t picture();                              // shadowPicture's target
    xcb_pixmap_t            createShadowPixmap(const QRect rect);
    xcb_render_picture_t createShadowPicture();
    xcb_render_picture_t createPicture();
    void                         destroyShadowPixmap();
    void                         destroyShadowPicture();
    void                         destroyPicture();
    xcb_pixmap_t            shadowPixmap();
    xcb_gcontext_t          gc();
    xcb_gcontext_t          createGC();
    void                          destroyGC();
#endif
...
private:
    ...
    xcb_pixmap_t                         m_pixmap_shadow;     // flip by hand to avoid cursor tearing
    xcb_render_picture_t               m_pict_shadow;           // flip by hand to avoid cursor tearing
    xcb_render_picture_t               m_pict;
    xcb_gcontext_t                        m_gc;
#endif
};
