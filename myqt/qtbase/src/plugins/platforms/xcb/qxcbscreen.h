...
public:
    ...
    QSizeF virtualSize() const { return m_virtualSize; }
    ...
    xcb_window_t root() const { return m_screen->root; }    //注意这个root window 是xcb_xcreen 的root window
