...
void Configure::parseCmdLine()
{
    ...
    for (; i<configCmdLine.size(); ++i) {
        ...
        else if(configCmdLine.at(i) == "-mrofs") {
            dictionary["MROFS"] = "yes";
        } else if(configCmdLine.at(i) == "-no-mrofs") {
            dictionary["MROFS"] = "no";
        }

        else if(configCmdLine.at(i) == "-mrdp") {
            dictionary["MRDP"] = "yes";
        } else if(configCmdLine.at(i) == "-no-mrdp") {
            dictionary["MRDP"] = "no";
        }
...
bool Configure::displayHelp()
{
    if (dictionary[ "HELP" ] == "yes") {
        ...
        desc("MROFS", "no", "-no-mrofs", "Do not build support for MROFS(MindRay Offscreen Surface).");
        desc("MROFS", "yes", "-mrofs", "Build support for MROFS.");
        desc("MRDP", "no", "-no-mrdp", "Do not build support for MRDP(Mindray Remote Display Protocol).");
        desc("MROFS", "yes", "-mrdp", "Build support for MRDP.");
...
void Configure::generateOutputVars()
{
    ...
    if( dictionary["MROFS"] == "yes")
        qtConfig += "mrofs";

    if( dictionary["MRDP"] == "yes")
        qtConfig += "mrdp";
...
void Configure::displayConfig()
{
    ...
    sout << "MrOfs support........." << dictionary[ "MROFS" ] << endl;
    sout << "Mrdp support........." << dictionary[ "MRDP" ] << endl;    
