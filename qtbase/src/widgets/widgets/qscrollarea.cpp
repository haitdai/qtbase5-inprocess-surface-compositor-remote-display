...
void QScrollAreaPrivate::updateWidgetPosition()
{
    ...
    //DHT20141125
//    qWarning("QScrollAreaPrivate::updateWidgetPosition[scrolled]: %d, %d, %d, %d",  scrolled.x(), scrolled.y(), scrolled.width(), scrolled.height());    
//    qWarning("QScrollAreaPrivate::updateWidgetPosition[widget]: %d, %d, %d, %d",  widget->x(), widget->y(), widget->width(), widget->height());    
//    qWarning("QScrollAreaPrivate::updateWidgetPosition[viewport]: %d, %d, %d, %d",  viewport->x(), viewport->y(), viewport->width(), viewport->height());    
    //END
}
