...
void QPlatformBackingStore::endPaint2()
{
}
...
#ifdef QT_MROFS
void QPlatformBackingStore::doResize(const QSize &size, const QRegion &staticContents)
{
    Q_UNUSED(size);
    Q_UNUSED(staticContents);
}

QPlatformCompositor* QPlatformBackingStore::compositor()
{
    return NULL;
}

static QRegion rgn_dummy;
QRegion& QPlatformBackingStore::effectiveClip()
{
    return rgn_dummy;
}

void QPlatformBackingStore::cleanEffectiveClip()
{
