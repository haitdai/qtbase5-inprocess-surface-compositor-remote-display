...
#ifdef QT_MROFS
    void setCompositor(QPlatformCompositor *plat_compositor);
    QPlatformImage *createShadowImage(const QRect rect);    
    void destroyShadowImage();    
    QPlatformImage *shadowImage();
#endif
...
private:
    ...
    QPlatformImage       *m_image_shadow;        // flicker killer
#endif
};
